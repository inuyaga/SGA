...
from aplicaciones.compra.views import CompraList, CompraCreate, CompraUpdate, CompraDelete
...
urlpatterns = [
    ...
    path('eliminarcompra/<int:pk>/', CompraDelete.as_view(), name='eliminarcompra'),
